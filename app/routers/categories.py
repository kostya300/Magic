...
async def create_category(
    ...
    """
    Создаёт новую категорию (только для seller и admin).
    """
...
async def update_category(
    ...
    """
    Обновляет категорию по её ID (только для seller и admin).
    """
...
async def delete_category(
    ...
    """
    Удаляет категорию по её ID.устанавливая is_active=False (только для seller и admin).
    """
